...
try:
    EVIDENCE_PRICE_ATOMIC = int(os.environ.get("EVIDENCE_PRICE_ATOMIC") or "7500")
except ValueError:
    EVIDENCE_PRICE_ATOMIC = 7500
try:
    EVIDENCE_PRICE_USDC = float(os.environ.get("EVIDENCE_PRICE_USDC") or "0.0075")
except ValueError:
    EVIDENCE_PRICE_USDC = 0.0075
...
MAX_REAL_EVIDENCE_PAID_CALLS = _i("MAX_REAL_EVIDENCE_PAID_CALLS", 20)
MAX_DISTINCT_EVIDENCE_BUYERS = _i("MAX_DISTINCT_EVIDENCE_BUYERS", 10)
...
PUBLIC_PATHS = {
    ...
    "/AGENTS.md",
    "/sitemap.xml",
    "/8f2c1a9e4b774d1e9c6a0b3d5e7f1021.txt",
    "/v1/json/inspect",
    "/v1/json/validate",
    "/v1/json/repair",
    "/v1/json/reliable",
    ...
    "/v1/url/tls-check",
    "/v1/url/robots-audit",
    "/v1/url/redirect-check",
    "/v1/api/openapi-audit",
    "/v1/api/openapi-diff",
    "/v1/api/schema-drift",
    "/v1/mcp/preflight",
    "/v1/x402/preflight",
